CREATE OR REPLACE PACKAGE pck_adresa AS
    ...
    PROCEDURE manage_adresa(
        ...
        p_zakaznik_id   IN adresa.zakaznik_id%TYPE,
        o_result        OUT CLOB
    );
...
CREATE OR REPLACE PACKAGE BODY pck_adresa AS
    ...
    BEGIN
        IF p_adresa_id IS NULL THEN
            INSERT INTO ADRESA(ULICE, CISLO_POPISNE, MESTO, PSC, POZNAMKA, STAT_ID, ZAKAZNIK_ID)
                VALUES(p_ulice, p_cislo_popisne, p_mesto, p_psc, p_poznamka, p_stat_id, p_zakaznik_id)
