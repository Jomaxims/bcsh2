...
public class AdresaRepository : BaseRepository
{
    ...
    public int AddOrEdit(AdresaModel model) => AddOrEdit(_adresaDao, model, MapToDto);

    public void Delete(int id) => Delete(_adresaDao, id);
    
    private Adresa MapToDto(AdresaModel model) => new()
    {
