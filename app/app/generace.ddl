...
CREATE TABLE log_zakaznici (
    log_id        INTEGER
        GENERATED BY DEFAULT AS IDENTITY ( START WITH 1 NOCACHE ORDER )
    NOT NULL,
    nazev_tabulky VARCHAR2(30) NOT NULL,
    cas_zmeny     DATE NOT NULL,
    id_instance   INTEGER NOT NULL,
    zakaznik_id   INTEGER
);

ALTER TABLE log_zakaznici ADD CONSTRAINT log_zakaznici_pk PRIMARY KEY ( log_id );

CREATE TABLE log_zamestnanci (
    log_id         INTEGER
        GENERATED BY DEFAULT AS IDENTITY ( START WITH 1 NOCACHE ORDER )
    NOT NULL,
...
ALTER TABLE log_zamestnanci ADD CONSTRAINT log_zamestnanci_pk PRIMARY KEY ( log_id );
...
CREATE TABLE pokoje_zajezdu (
    celkovy_pocet_pokoji    INTEGER NOT NULL,
    pocet_obsazenych_pokoju INTEGER NOT NULL,
    terminy_id              INTEGER NOT NULL,
    pokoj_id                INTEGER NOT NULL
);

ALTER TABLE pokoje_zajezdu ADD CONSTRAINT pokoje_zajezdu_pk PRIMARY KEY ( terminy_id,
                                                                          pokoj_id );
...
CREATE TABLE strava_zajezdu (
    strava_id INTEGER NOT NULL,
    zajezd_id INTEGER NOT NULL
);

ALTER TABLE strava_zajezdu ADD CONSTRAINT strava_zajezdu_pk PRIMARY KEY ( strava_id,
                                                                          zajezd_id );
...
ALTER TABLE termin ADD CONSTRAINT termin_pk PRIMARY KEY ( terminy_id );

CREATE TABLE typ_ubytovani (
    typ_ubytovani_id INTEGER
        GENERATED BY DEFAULT AS IDENTITY ( START WITH 1 NOCACHE ORDER )
    NOT NULL,
    nazev            VARCHAR2(50) NOT NULL
);

ALTER TABLE typ_ubytovani ADD CONSTRAINT typ_ubytovani_pk PRIMARY KEY ( typ_ubytovani_id );
...
CREATE TABLE ubytovani (
    ...
    obsazenost       NUMBER NOT NULL,
    adresa_id        INTEGER NOT NULL,
    typ_ubytovani_id INTEGER NOT NULL,
...
ALTER TABLE udaje ADD CONSTRAINT udaje_pk PRIMARY KEY ( udaje_id );
...
ALTER TABLE uroven ADD CONSTRAINT uroven_pk PRIMARY KEY ( pocet_hvezd );
...
CREATE UNIQUE INDEX zamestnanec__idxv1 ON
    zamestnanec (
        udaje_id
    ASC );
...
ALTER TABLE log_zakaznici
    ADD CONSTRAINT log_zakaznici_zakaznik_fk FOREIGN KEY ( zakaznik_id )
        REFERENCES zakaznik ( zakaznik_id );

ALTER TABLE log_zamestnanci
    ADD CONSTRAINT log_zamestnanci_zamestnanec_fk FOREIGN KEY ( zamestnanec_id )
        REFERENCES zamestnanec ( zamestnanec_id );

ALTER TABLE objednavka
    ADD CONSTRAINT objednavka_doprava_fk FOREIGN KEY ( doprava_id )
...
ALTER TABLE objednavka
    ADD CONSTRAINT objednavka_termin_fk FOREIGN KEY ( terminy_id )
        REFERENCES termin ( terminy_id );

ALTER TABLE objednavka
    ADD CONSTRAINT objednavka_zajezd_fk FOREIGN KEY ( zajezd_id )
...
ALTER TABLE pokoje_zajezdu
    ADD CONSTRAINT pokoje_zajezdu_pokoj_fk FOREIGN KEY ( pokoj_id )
        REFERENCES pokoj ( pokoj_id );

ALTER TABLE pokoje_zajezdu
    ADD CONSTRAINT pokoje_zajezdu_termin_fk FOREIGN KEY ( terminy_id )
        REFERENCES termin ( terminy_id );

ALTER TABLE strava_zajezdu
    ADD CONSTRAINT strava_zajezdu_strava_fk FOREIGN KEY ( strava_id )
        REFERENCES strava ( strava_id );

ALTER TABLE strava_zajezdu
    ADD CONSTRAINT strava_zajezdu_zajezd_fk FOREIGN KEY ( zajezd_id )
        REFERENCES zajezd ( zajezd_id );
...
ALTER TABLE ubytovani
    ADD CONSTRAINT ubytovani_typ_ubytovani_fk FOREIGN KEY ( typ_ubytovani_id )
        REFERENCES typ_ubytovani ( typ_ubytovani_id );

ALTER TABLE ubytovani
    ADD CONSTRAINT ubytovani_uroven_fk FOREIGN KEY ( pocet_hvezd )
        REFERENCES uroven ( pocet_hvezd );
...
ALTER TABLE zakaznik
    ADD CONSTRAINT zakaznik_udaje_fk FOREIGN KEY ( udaje_id )
        REFERENCES udaje ( udaje_id );

ALTER TABLE zamestnanec
    ADD CONSTRAINT zamestnanec_osoba_fk FOREIGN KEY ( osoba_id )
        REFERENCES osoba ( osoba_id );
...
ALTER TABLE zamestnanec
    ADD CONSTRAINT zamestnanec_udaje_fk FOREIGN KEY ( udaje_id )
        REFERENCES udaje ( udaje_id );
